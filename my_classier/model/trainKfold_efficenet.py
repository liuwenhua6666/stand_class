...
def loaddata(train_dir, batch_size, shuffle,is_train=True):
    ...
    dataset_loaders = torch.utils.data.DataLoader(image_datasets, batch_size=batch_size, shuffle=True, num_workers=0)
...
if __name__ == "__main__":
    ...
    for model_name in model_list:
        ...
        if model_name == 'EfficientNet':
            ...
            # model._fc = nn.Linear(2560, 3)
            # model._fc = nn.Linear(512, 3)
        else:
